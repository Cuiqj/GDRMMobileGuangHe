...
- (void)pageLoadInfo
{
    ...
    //案由
    self.textcase_short_desc.text = [NSString stringWithFormat:@"%@%@%@", citizen.automobile_number, citizen.automobile_pattern, self.caseProveInfo.case_short_desc];
    ...
    if ([citizen.org_name isEmpty]&&[citizen.org_principal_duty isEmpty]) {
        self.textcitizen_duty.text = nil;
    }else{
